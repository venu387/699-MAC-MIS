...
<body>
	...
	<div class="container">
		<div class="container-fluid">
			<div>
				<h3 class="mt-4 mb-4">Staff List</h3>
				<a href="/member/addfaculty"
			...
			<table class="table table-striped">
				...
				<tbody>
					<c:forEach items="${studentsList}" var="student">
						<tr>
							<th scope="row"><c:out value="${student.sid}"></c:out></th>
							...
							<td>
								<button class="btn btn-primary btn-sm jobdetail btnMemberDetails"
									data-id="${student.sid}" data-type="1">Details</button> <a
								href="/member/addstaff?memberId=${student.sid}"
