...
<body>
	...
	<div class="container">
		<div class="container-fluid">
			<div>
				<h3 class="mt-4 mb-4">Create/Edit Staff Profile</h3>
			</div>
			<form:form commandName="student" action="/member/addstaff"
				...
				<div class="col-9">
					<form:input path="type" value="${student.type}" class="form-control"
						type="hidden"></form:input>
				</div>
				<div class="form-group row">
					...
					<div class="col-9">
						<form:input path="firstName" value="${student.firstName}"
							class="form-control" type="text" id="textSFName"
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<form:input path="middleName" value="${student.middleName}"
							class="form-control" type="text" id="textSLName"
						...
						<div class="form-group row disabled">
							...
							<div class="col-9">
								<form:input path="emailId" value="${student.emailId}"
									class="form-control" type="text" id="textSEmail"
									placeholder="" required="required"></form:input>
							</div>
						</div>
					</c:when>
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<form:input path="telephone" value="${student.telephone}"
							class="form-control" type="tel" id="textTel"
							placeholder=""></form:input>
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<form:input path="city" class="form-control" type="text"
							value="${student.city}" id="textCompanyCity"
							placeholder=""></form:input>
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<form:input path="country" class="form-control" type="text"
							value="${student.country}" id="textCompanyCountry"
							placeholder=""></form:input>
					</div>
				</div>
				<div class="form-group row">
